...
export const getFolloweesbyId = async (id) => {
  try {
    // add the token to the header
    setHeaders();
    const response = await axios.get(`http://localhost:8080/users/${id}/followees`);
    reAuthenticate(response.status);
    return response.data;
  } catch (err) {
    console.error(err);
...
export const getRecommendationById = async (id) => {
  try {
    // add the token to the header
    setHeaders();
    const response = await axios.get(`http://localhost:8080/recommendation/${id}`);
    reAuthenticate(response.status);
    return response.data;
  } catch (err) {
    console.error(err);
...
export const updateUserInfo = async (id, userObject) => {
  try {
    // add the token to the header
    setHeaders();
    const response = await axios.put(`http://localhost:8080/users/${id}`, userObject);
    reAuthenticate(response.status);
    return response.data.data;
  } catch (err) {
    console.error(err);
...
export const getAllPostsById = async (id) => {
  try {
    // add the token to the header
    setHeaders();
    const response = await axios.get(`${rootURL}/posts/${id}?p=0`);
    reAuthenticate(response.status);
    return response.data;
  } catch (err) {
    reAuthenticate(401);
...
export const getPostsNumById = async (id) => {
  try {
    // add the token to the header
    setHeaders();
    const response = await axios.get(`${rootURL}/num/${id}`);
    return response.data;
  } catch (err) {
    console.error(err);
    reAuthenticate(401);
...
export const getPostsPerPage = async (page) => {
  try {
    ...
    // add the token to the header
    setHeaders();
    const response = await axios.get(`${rootURL}/posts/${viewerId}?p=${page}`);
    reAuthenticate(response.status);
    return response.data;
  } catch (err) {
    reAuthenticate(401);
...
export const getPostById = async (id) => {
  try {
    // add the token to the header
    setHeaders();
    const response = await axios.get(`${rootURL}/post/${id}`);
    reAuthenticate(response.status);
    return response.data;
  } catch (err) {
    console.error(err);
...
export const updateLike = async (postObject, id, UID) => {
  try {
    ...
    // add the token to the header
    setHeaders();
    await axios.put(`${rootURL}/post/${id}`, postObject);
    // return response.data;
...
export const updatePost = async (postObject, id) => {
  try {
    ...
    await axios.put(`${rootURL}/post/${id}`, postUpdates);
  } catch (err) {
    console.error(err);
    reAuthenticate(401);
  }
...
export const deletePostbyId = (id) => {
  try {
    // add the token to the header
    setHeaders();
    return axios.delete(`${rootURL}/post/${id}`);
  } catch (err) {
    console.error(err);
    reAuthenticate(401);
  }
...
export const updateInvisi = async (id, invisiArr) => {
  try {
    // add the token to the header
    setHeaders();
    const response = await axios.put(`http://localhost:8080/invisi/${id}`, invisiArr);
    return response.data.data;
  } catch (err) {
    console.error(err);
    reAuthenticate(401);
...
export const getInvisiByUserId = async (id) => {
  try {
    // add the token to the header
    setHeaders();
    const response = await axios.get(`http://localhost:8080/invisi/${id}`);
    return response.data.data;
  } catch (err) {
    console.error(err);
    reAuthenticate(401);
...
export const getCommentsByPostId = async (id) => {
  try {
    // add the token to the header
    setHeaders();
    const response = await axios.get(`http://localhost:8080/comments/${id}`);
    reAuthenticate(response.status);
    return response.data;
  } catch (err) {
    console.error(err);
